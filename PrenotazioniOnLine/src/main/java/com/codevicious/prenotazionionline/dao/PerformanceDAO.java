...
import com.codevicious.prenotazionionline.dao.mappers.SchedaPerformanceMapper;
...
public interface PerformanceDAO {
	...
	@SqlQuery("  SELECT s.* FROM scheda_performance as s INNER join profili_performance as p on p.fk_scheda = s.id WHERE p.id=:perf_user_id")
	SchedaPerformance getSchedaPerfUserByID(@Bind("perf_user_id") long perf_user_id);
