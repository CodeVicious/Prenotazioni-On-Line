...
public class PerformanceUser {
	...
	public PerformanceUser(long l, int m, Date date, Date date2, int giorni_lavorati,
			boolean cP, String responsabilita_speciali, String nome, String s, String dO,
			...
			String capitolo_irap_standard, long n, long o, long p,
			long q) {
		
		this.id = l;
		Anno = m;
		this.inizio_incarico = date;
		this.fine_incarico = date2;
		...
		this.fk_sectors = n;
		this.fk_profilo_professionale = o;
		this.fk_categoria_giuridica = p;
		this.fk_user = q;
	}
	...
	public Date getInizio_incarico() {
		return inizio_incarico;
	}

	public void setInizio_incarico(Date inizio_incarico) {
		this.inizio_incarico = inizio_incarico;
	}

	public Date getFine_incarico() {
		return fine_incarico;
	}

	public void setFine_incarico(Date fine_incarico) {
